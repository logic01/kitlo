        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StripeAccountId = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetBookingId = table.Column<Guid>(type: "uuid", nullable: true),
                    TargetDisputeId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GearTypeLabel = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: false),
                    Condition = table.Column<int>(type: "integer", nullable: false),
                    Description = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: false),
                    PickupZip = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    DailyRateCents = table.Column<int>(type: "integer", nullable: false),
                    DepositCents = table.Column<int>(type: "integer", nullable: true),
                    ServiceFeeBp = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptedOutMask = table.Column<long>(type: "bigint", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentalCents = table.Column<int>(type: "integer", nullable: false),
                    DepositCents = table.Column<int>(type: "integer", nullable: false),
                    ...
                    PickupConfirmedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    ReturnConfirmedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bookings_Users_ListerId",
                        column: x => x.ListerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BundleListingId = table.Column<Guid>(type: "uuid", nullable: false),
                    ChildListingId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BundleItems", x => new { x.BundleListingId, x.ChildListingId });
                    table.ForeignKey(
                        name: "FK_BundleItems_Listings_BundleListingId",
                        column: x => x.BundleListingId,
                        principalTable: "Listings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BundleItems_Listings_ChildListingId",
                        column: x => x.ChildListingId,
                        principalTable: "Listings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListingSpecs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ListingSpecs_Listings_ListingId",
                        column: x => x.ListingId,
                        principalTable: "Listings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    Reason = table.Column<int>(type: "integer", nullable: false),
                    ReasonLabel = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    Summary = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: false),
                    AmountInDisputeCents = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Disputes_Users_FiledById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastMessagePreview = table.Column<string>(type: "character varying(280)", maxLength: 280, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MessageThreads_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingId = table.Column<Guid>(type: "uuid", nullable: false),
                    ListerId = table.Column<Guid>(type: "uuid", nullable: false),
                    GrossCents = table.Column<int>(type: "integer", nullable: false),
                    PlatformFeeCents = table.Column<int>(type: "integer", nullable: false),
                    NetCents = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    StripeTransferId = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
                    BankLast4 = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Payouts_Users_ListerId",
                        column: x => x.ListerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TagsJson = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DisputeEvidence_Users_UploadedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BundleItems_ChildListingId",
                table: "BundleItems",
                column: "ChildListingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Listings_GearType_Status",
                table: "Listings",
                columns: new[] { "GearType", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Listings_PickupZip",
                table: "Listings",
                column: "PickupZip");

            migrationBuilder.CreateIndex(
                name: "IX_ListingSpecs_ListingId",
                table: "ListingSpecs",
                column: "ListingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageThreads_BookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_BookingId_Kind",
                table: "Reviews",
                columns: new[] { "BookingId", "Kind" },
                unique: true);
