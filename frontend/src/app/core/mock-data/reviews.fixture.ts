    ...
    reviews: [
      {
        ...
        rating: 5,
        accuracy: 'accurate',
        text: 'Picked up heat at 800 yards no problem. Multiple reticle options dialed in fast. Tyler is a pro.',
        tags: ['clear image', 'fully charged'],
      },
    ],
  },
  {
    ...
    reviews: [
      {
        ...
        rating: 5,
        accuracy: 'accurate',
        text: 'Rangefinder integration is a game-changer for first-light scouting. Powered up and was glassing in five minutes.',
        tags: ['rangefinder accurate', 'quick setup'],
      },
    ],
  },
  {
...
export const MOCK_RENTER_REVIEWS: Review[] = [
  ...
  },
  {
    ...
    reviewedAt: '2026-02-13',
    rating: 5,
    text: 'Careful with the optic, brought it back cleaner than I gave it.',
  },
];
